...
import { generateCheckNumber } from '../../utils/validators';
...
type Line = { upc: string; qty: number };
...
export function CreateReceiptPage() {
  ...
  const refreshData = useCallback(async () => {
    ...
    try {
      ...
      setCards((c.data as ClientCard[]) || []);
      const items = (s.data as StoreItem[]) || [];
      setStoreItems(items);
